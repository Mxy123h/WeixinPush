 ...
 * 开始推送
 */
$appID = 'wxf0dxxxxxxxxxx'; //你的appID
$appsecret = '4d3b651eb3xxxxxxxxxxxxxxxxxxxx'; //你的appsecret
$tousers = array('olj-jxxxxxxxxxxxxs', 'olj-j6tFCNxxxxxxxxxxxxxx_s'); //关注测试号的用户
$template_id = '8GPV_s2lYexxxxxxxxxxxxvxxxxxxxxxxxs'; //消息模板ID
$msgUrl = 'https://domain.com/push/msg.php'; //你的目录
//替换你的ACCESS_TOKEN
$ACCESS_TOKEN = json_decode(https_request("https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=".$appID.
    "&secret=".$appsecret), true)["access_token"];
//echo($ACCESS_TOKEN);
//模板消息请求URL
